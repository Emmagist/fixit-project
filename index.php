          ...
          <?php foreach (User::getPopularWorkDone() as $provider):?>
            <div class="col-md-4">
              <a href="service_prov.php?user=<?=$provider['user_token']?>">
                <div class="prof-services mt-5" style="background-image: url('<?=$provider['work_image']?>'); background-repeat:no-repeat;height:30vh;background-size:cover;background-position:center;">
